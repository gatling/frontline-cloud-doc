...
You can either use the public locations provided by Gatling Enterprise Cloud, or use your own.
...
If you want to use private locations, please refer to the [specific documentation]({{< ref "../private_locations" >}})
