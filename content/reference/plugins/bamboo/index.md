...
* The second one is named `frontline.apiTokenPassword`, and corresponds to the [API token]({{< ref "../../admin/api_tokens" >}}) needed to authenticate to Gatling Enterprise. The API token needs the Start permission.
